...
# 権限を設定
sudo chown -R YOUR_USERNAME:users /home/YOUR_USERNAME/meeting-minutes-data
sudo chmod -R 755 /home/YOUR_USERNAME/meeting-minutes-data
...
pwd
# 出力: /var/services/homes/YOUR_USERNAME/nas-project/meeting-minutes-byc
